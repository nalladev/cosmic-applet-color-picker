...
6. merge the 3 colour row in the popup menu into a single section still 3 rows but instead of 3 line separated sections simply 1 section for the colour values how is the cosmic design ethic for the menu popup in our case.
7. fix ai generated readme - look through existing readmes of other applets. especially system applets also the most popular 3rd party applets.
